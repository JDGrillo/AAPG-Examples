...
# 	data_file += ".csv"
# data_file = "data-files/Joined-Master-Dataset.csv"
...
ax = master_df.plot(kind="scatter", x="Depth (ft)",y="Modeled Quartz", color="b", label="Modeled Quartz")
df.plot(x="Depth (ft)",y="Quartz", color="r", label="Actual Quartz"", ax=ax)

# master_df.plot.scatter(x="Depth (ft)", y="Modeled Quartz", c="DarkBlue")
